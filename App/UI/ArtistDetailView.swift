...
struct ArtistDetailView: View {
    ...
    // Eigener Kopfbereich statt nur navigationTitle: der spielt (anders als
    // die reine Titelzeile) sofort alle Titel des Artist ab, ohne erst in
    // eine der drei Sektionen wechseln zu müssen — bleibt außerhalb des
    // Lade-Group, damit er auch während des Ladens/bei einem Fehler nutzbar ist.
